...
const policySections = [
    {
        ...
        content: "EcoTrack AI collects information you provide directly, such as your name, email address, sustainability preferences, and interactions with our AI-powered features.",
        icon: FaDatabase,
        color: "bg-emerald-100 text-emerald-600 border-emerald-100",
    },
    {
        title: "How We Use Your Information",
        content: "We use your information to provide personalized sustainability recommendations, improve our AI services, and enhance your overall experience on the platform.",
        icon: FaUserShield,
    ...
    {
        title: "Your Rights",
        content: "You have the right to access, update, or delete your personal information. You may also contact us regarding any privacy-related concerns.",
        icon: FaUserCheck,
        color: "bg-emerald-100 text-emerald-600 border-emerald-100",
    },
    {
        title: "Contact Us",
        content: "If you have any questions about this Privacy Policy, please contact us at support@ecotrack.ai.",
        icon: FaEnvelope,
        color: "bg-cyan-100 text-cyan-600 border-cyan-100",
    },
];
        ...
        <div className="min-h-screen bg-linear-to-br from-emerald-50/60 via-white to-cyan-50/60 pb-24">
            ...
            <div className="relative overflow-hidden pt-20 pb-16 text-center">
                ...
                <div className="mx-auto max-w-4xl px-4">
                    ...
                    >
                        Privacy <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500">Policy</span>
                    </motion.h1>
