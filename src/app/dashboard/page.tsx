...
export default function DashboardPage() {
    ...
    const stats = [
        ...
        { title: "Carbon Saved", value: `${user?.carbonSaved ?? 0} kg`, icon: <FaChartLine /> },
    ...
    return (
        <div className="p-6 md:p-10">
            ...
            <p className="text-slate-500 mt-2">Here is your sustainability overview.</p>

            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mt-8">
                {stats.map((item) => (
                    <div key={item.title} className="bg-white rounded-2xl border p-6 shadow-sm">
